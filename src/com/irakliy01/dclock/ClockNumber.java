...
public class ClockNumber implements ClockEventListener {
    ...
    ClockNumber(double size, double X, double Y) {
        ...
        number.getChildren().add(new Segment(size, Color.RED, X, Y - size * 3).rotate(90).getSegment());
        number.getChildren().add(new Segment(size, Color.RED, X, Y + size * 2).rotate(90).getSegment());
        number.getChildren().add(new Segment(size, Color.RED, X - size * 2, Y + size * 4.5).getSegment());
        number.getChildren().add(new Segment(size, Color.RED, X - size * 4, Y + size * 2).rotate(90).getSegment());
        number.getChildren().add(new Segment(size, Color.RED, X - size * 4, Y - size * 3).rotate(90).getSegment());
